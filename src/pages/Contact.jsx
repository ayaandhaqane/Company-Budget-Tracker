      ...
      <section className="py-10 bg-gray-100 sm:py-16 lg:py-24">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl">Get in Touch with Us</h2>
            <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-500">
              We are dedicated to helping you manage your finances better. Whether you have a question, suggestion, or just want to learn more, we're here to assist you. Reach out to us through the form or use the contact information below.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
              ...
              <div className="overflow-hidden bg-white rounded-xl">
                <div className="p-6">
                  ...
                  <p className="mt-6 text-lg font-medium text-gray-900">+252616000000</p>
                  <p className="mt-1 text-lg font-medium text-gray-900">+252615000000</p>
                </div>
              </div>
              ...
              <div className="overflow-hidden bg-white rounded-xl">
                <div className="p-6">
                  ...
                  <p className="mt-6 text-lg font-medium text-gray-900">contact@budgettracker.com</p>
                  <p className="mt-1 text-lg font-medium text-gray-900">support@budgettracker.com</p>
                </div>
              </div>
              ...
              <div className="overflow-hidden bg-white rounded-xl">
                <div className="p-6">
                  ...
                  <p className="mt-6 text-lg font-medium leading-relaxed text-gray-900">Somalia, Mogudisho</p>
                </div>
              </div>
            </div>
                ...
                <form action="#" method="POST" className="mt-14">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                    ...
                    <div>
                      ...
                      <div className="mt-2.5 relative">
                        <input type="email" name="" id="" placeholder="Enter your email" className="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
                      </div>
                    </div>
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <div className="mt-2.5 relative">
                        <textarea name="" id="" placeholder="Your message here..." className="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md resize-y focus:outline-none focus:border-blue-600 caret-blue-600" rows="4"></textarea>
                      </div>
                    </div>
